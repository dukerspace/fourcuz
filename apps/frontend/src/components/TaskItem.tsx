  ...
  return (
    <div
      className={`flex justify-between items-center py-[18px] px-[18px] bg-gray-50 dark:bg-gray-800 rounded-xl border-2 cursor-pointer transition-all duration-250 ${
        isSelected
          ? 'border-emerald-600 dark:border-emerald-400 bg-[rgba(52,211,153,0.12)] dark:bg-[rgba(52,211,153,0.18)] shadow-[0_2px_12px_rgba(52,211,153,0.2)] dark:shadow-[0_2px_12px_rgba(52,211,153,0.3)]'
    ...
    >
      <div
        className="flex items-center justify-center py-1 px-2 cursor-grab opacity-50 hover:opacity-100 transition-opacity duration-200 flex-shrink-0 text-gray-600 dark:text-gray-400 active:cursor-grabbing"
      ...
      <div className="flex gap-2 flex-shrink-0">
        <button
          className="w-7 h-7 rounded-full text-xl leading-none flex items-center justify-center transition-all duration-200 cursor-pointer bg-emerald-600 text-white dark:bg-emerald-400 hover:bg-emerald-700 dark:hover:bg-emerald-500 hover:scale-110"
          onClick={(e) => {
            e.stopPropagation()
